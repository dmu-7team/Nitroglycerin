...
namespace MarsFPSKit
{
    ...
    public class Kit_BotRandomLoadoutManager : Kit_BotLoadoutManager
    {
        ...
        {
            Kit_GameInformation game = Kit_IngameMain.instance.gameInformation;
            ...
            //Find a secondary
            Kit_WeaponBase[] secondaries = Array.FindAll(Kit_IngameMain.instance.gameInformation.allWeapons, x => x.CanBeSelectedInLoadout() && x.weaponType.GetLocalizedString() == game.allWeaponCategories[1].GetLocalizedString());
