    ...
    namespace UI
    {
        public class Kit_PvE_SandboxMenu : Kit_MenuPveGameModeBase
        {
            ...
            public void CoopStart()
            {
                ...
                {
                    if (menuManager.eventSystem)
                    {
                        //Deactivate all input
                        menuManager.eventSystem.enabled = false;
                    }
                    //Load the map
                    Kit_SceneSyncer.instance.LoadScene(menuManager.game.allCoopGameModes[myId].maps[coopNetworkData.coopCurMap].sceneName);
                }
            }
            ...
            private void RedrawCoopMenu()
            {
                ...
                coopMapName.text = menuManager.game.allCoopGameModes[myId].maps[coopNetworkData.coopCurMap].mapName;
