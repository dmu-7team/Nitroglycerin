...
namespace MarsFPSKit
{
    ...
    public class Kit_BasicMouseLook : Kit_MouseLookBase
    {
        ...
        public override void InitializeServer(Kit_PlayerBehaviour pb)
        {
            ...
            Kit_BasicMouseLookNetworkData nData = data.GetComponent<Kit_BasicMouseLookNetworkData>();
        ...
        {
            //Get our custom data
            Kit_BasicMouseLookNetworkData data = pb.customMouseLookData as Kit_BasicMouseLookNetworkData;
        ...
        public override bool ReachedYMax(Kit_PlayerBehaviour pb)
        {
            ...
            if (pb.customMouseLookData != null && pb.customMouseLookData.GetType() == typeof(Kit_BasicMouseLookNetworkData))
            {
                //Get our custom data
                Kit_BasicMouseLookNetworkData data = pb.customMouseLookData as Kit_BasicMouseLookNetworkData;
