                                ...
                                for (int p = 0; p < attachmentVisualBehaviours.Length; p++)
                                {
                                    ...
                                    else if (attachmentVisualBehaviours[p].GetType() == typeof(Kit_AttachmentRenderer))
                                    {
                                        ...
                                        if (pb)
                                        {
                                            ...
                                            {
                                                Debug.LogError("FPV2 is enabled but attachment first person prefab does not have FPV_SM_Object assigned!");
                                            }
                                            ...
                                            {
                                                Debug.LogError("FPV3 is enabled but attachment first person prefab does not have FPV_Object assigned!");
                                            }
#endif
                                        }
                                    }
