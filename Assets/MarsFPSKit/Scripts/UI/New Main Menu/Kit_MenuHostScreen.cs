    ...
    namespace UI
    {
        public class Kit_MenuHostScreen : MonoBehaviour
        {
            ...
            void UpdateAllDisplays()
            {
                ...
                //Game Mode
                curGameModeLabel.text = menuManager.game.allPvpGameModes[currentGameMode].gameModeName.GetLocalizedString();

                //Duration
                curDurationLabel.text = localizationDuration.GetLocalizedString((menuManager.game.allPvpGameModes[currentGameMode].traditionalDurations[currentDuration] / 60));

                //Player Limit
                curPlayerLimitLabel.text = localizationPlayerCount.GetLocalizedString(menuManager.game.allPvpGameModes[currentGameMode].traditionalPlayerLimits[currentPlayerLimit]);

                //Player Limit
                curPlayersNeededLabel.text = localizationPlayerCount.GetLocalizedString(menuManager.game.allPvpGameModes[currentGameMode].traditionalPlayerNeeded[currentPlayerNeeded]);

                //Ping Limit
                if (menuManager.game.allPvpGameModes[currentGameMode].traditionalPingLimits[currentPingLimit] > 0)
                    curPingLimitLabel.text = localizationPingLimit.GetLocalizedString(menuManager.game.allPvpGameModes[currentGameMode].traditionalPingLimits[currentPingLimit]);
                else
                ...
                {
                    curAfkLimitLabel.text = localizationAfkLimit.GetLocalizedString(menuManager.game.allPvpGameModes[currentGameMode].traditionalAfkLimits[currentAfkLimit].ToString());
                }
                else
